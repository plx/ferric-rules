...
[the compatibility reference](../../../docs/compatibility.md) and
[the compatibility roadmap](../../../COMPATIBILITY_ROADMAP.md) into small,
...
The roadmap's completed labels describe implementation status; they are not
coverage or compatibility claims for this corpus.

| Roadmap item | Corpus status |
|---|---|
...
| Fact query macros | All six query forms have focused cases plus empty/filter/order/mutation combinations; the cross-product of conditions and mutation behavior remains incomplete. |
...
| Complex constraints / compile-time function validation | The roadmap leaves these open; small positive examples here do not close either item. Dedicated accepted/rejected syntax characterization remains necessary. |
| Batch interpreter, file handles, eval/build | Remaining infrastructure in the roadmap, not assumed compatible by this corpus. |
...
[phase 2](../../../crates/ferric-runtime/src/phase2_integration_tests.rs) and
[phase 3](../../../crates/ferric-runtime/src/phase3_integration_tests.rs) exercise
engine/reset state; [phase 4](../../../crates/ferric-runtime/src/phase4_integration_tests.rs)
contains `load-facts`, `save-facts`, and file-roundtrip tests. Core
[strategy tests](../../../crates/ferric-core/src/strategy.rs), parser tests, and
the older [compatibility fixtures](../fixtures/) cover additional behavior.
They do not automatically provide independent CLIPS oracles for these holes.
