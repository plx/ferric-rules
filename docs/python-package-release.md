...
destroys native state. Engine operations serialize across Python threads, and
waiting for the native mutex also releases the GIL. This behavior neither admits a
