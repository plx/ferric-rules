...
/// Append an `implode$` field, quoting STRINGs and escaping only their quote
/// and backslash bytes. Control SYMBOLs retain their literal spelling.
pub(crate) fn append_implode_field(value: &Value, symbols: &SymbolTable, output: &mut ByteBuffer) {
