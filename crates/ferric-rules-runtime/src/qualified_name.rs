...
//! Runtime code re-exports parser-owned qualified-name utilities so both crates
//! share one representation and parser implementation.

pub use ferric_rules_parser::{parse_qualified_name, QualifiedName};
