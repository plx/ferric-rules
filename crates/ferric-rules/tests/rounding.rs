//! Issue #333: exact CLIPS rounding ties, float artifacts, and integer identity.
//!
//! These six programs are the complete positive reference inventory: the exact
//! original plus five distinct controls. Invalid-argument diagnostic phase/text
//! and host-only nonfinite inputs remain outside this positive golden contract.
//!
...
const FIXTURES: &[Fixture] = &[
    fixture!("011_round_half_boundaries"),
    fixture!("round_half_ladder"),
    fixture!("round_adjacent_halves"),
    fixture!("round_ordinary_nonties"),
    fixture!("round_integer_identity"),
    fixture!("round_large_integral_floats"),
];
...
golden_test!(
    original_half_integer_boundaries,
    "011_round_half_boundaries"
);
golden_test!(
    exact_half_ties_choose_the_lower_integer,
    "round_half_ladder"
);
golden_test!(
    adjacent_float_values_preserve_observed_subtraction_artifacts,
    "round_adjacent_halves"
);
golden_test!(
    ordinary_non_ties_round_to_the_nearer_integer,
    "round_ordinary_nonties"
);
golden_test!(
    integer_inputs_remain_exact_and_results_are_integers,
    "round_integer_identity"
);
golden_test!(
    large_float_results_preserve_reference_subtraction_rounding,
    "round_large_integral_floats"
);

#[test]
fn late_round_rules_run_against_existing_facts() {
...
#[cfg(feature = "serde")]
#[test]
fn pending_round_rules_resume_in_all_formats() {
...
#[cfg(feature = "serde")]
#[test]
fn late_round_rules_install_after_restore_in_all_formats() {
    use ferric_rules::runtime::SerializationFormat;
    for fixture in FIXTURES {
