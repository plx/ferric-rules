...
//!
//! ```sh
//! ferric-rules-bench-gen --output-dir target/bench-workloads
//! ```
...
// ---------------------------------------------------------------------------
// Waltz generator (from crates/ferric-rules/benches/waltz_bench.rs)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Manners generator (from crates/ferric-rules/benches/manners_bench.rs)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Join-width generator (from crates/ferric-rules/benches/join_bench.rs)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Churn generator (from crates/ferric-rules/benches/churn_bench.rs)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Negation generator (from crates/ferric-rules/benches/negation_bench.rs)
// ---------------------------------------------------------------------------
...
fn parse_args() -> Result<Config, String> {
    ...
    while i < args.len() {
        match args[i].as_str() {
            ...
            "-h" | "--help" => {
                eprintln!("Usage: ferric-rules-bench-gen --output-dir <path>");
                std::process::exit(0);
            }
